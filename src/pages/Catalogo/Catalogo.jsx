                ...
                <div className="card">
                    ...
                    <div className="corpo">
                        <ul className="catalogo-card">
                            ...
                            <li>Clima: Semiárido, baixa pluviosidade, altos níveis de radiação solar.</li>
                            <li>Observações: Esta variedade de trigo tem alta resiliência à seca prolongada e consegue completar seu ciclo de vida com pouca água.</li>
                        </ul>
                    </div>
                </div>
                <div className="card">
                    ...
                    <div className="corpo">
                        <ul className="catalogo-card">
                            ...
                            <li>Clima: Tropical úmido, altas taxas de precipitação.</li>
                            <li>Observações: Esse arroz é altamente tolerante a solos salinos e possui boa produtividade em áreas sujeitas à intrusão de água do mar, sendo uma opção estratégica para áreas costeiras afetadas por mudanças climáticas.</li>
                        </ul>
                    </div>
                </div>
                <div className="card">
